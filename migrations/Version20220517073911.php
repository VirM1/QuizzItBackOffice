...
final class Version20220517073911 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE question (id INT AUTO_INCREMENT NOT NULL, module_thematique_id INT NOT NULL, bonne_reponse_id INT DEFAULT NULL, titre_question VARCHAR(255) NOT NULL, note_question VARCHAR(255) DEFAULT NULL, aide_question VARCHAR(255) DEFAULT NULL, INDEX IDX_B6F7494E14BE9607 (module_thematique_id), UNIQUE INDEX UNIQ_B6F7494E809A8886 (bonne_reponse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, question_id INT NOT NULL, titre_reponse VARCHAR(255) NOT NULL, INDEX IDX_5FB6DEC71E27F6BF (question_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
